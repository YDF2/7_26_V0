...
// Legacy constants (deprecated, for backward compatibility during transition)
#define DROPBALL            255  // Use KICKING_TEAM_NONE instead

// Penalty codes (unified)
...
// Legacy penalty codes (deprecated, for backward compatibility during transition)
#define HL_PICKUP_OR_INCAPABLE_DEPRECATED     34
#define HL_SERVICE_DEPRECATED                 35
...
{
  char header[4];           // header to identify the structure ("RGme")
  uint8_t version;          // version of the data structure (19)
...
// data structure header for return messages
